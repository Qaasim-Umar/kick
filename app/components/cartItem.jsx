  ...
  return (
    <div className="flex justify-between items-center border-b-[#919191] border-b py-10 lg:mr-10">
      <div className="flex items-center space-x-4">
        <Image src={product.image} alt={product.name} width={100} height={120} className="w-[118px] h-[140px] object-cover bg-[#EDEEF2]" />
        <div>
          ...
          <button className="text-[#C00000] text-[20px] mt-2 flex items-center gap-2 font-medium font-space-grotesk">  <Image src="/img/stop.svg" width={17} height={12}  alt="" />Remove</button>
        </div>
      </div>
